...
#创建工程
#**********************************************************************************************************
create_project -force $proj_name $projpath/$proj_name -part xc7z100ffg900-2
...
add_files -fileset sources_1  -copy_to $projpath/$proj_name/$proj_name.srcs/sources_1/new -force -quiet [glob -nocomplain $tclpath/src/design/*.vhd]
add_files -fileset sources_1  -copy_to $projpath/$proj_name/$proj_name.srcs/sources_1/new -force -quiet [glob -nocomplain $tclpath/src/design/*.mif]

create_ip -name clk_wiz -vendor xilinx.com -library ip -version 6.0 -module_name syspll
...
generate_target {instantiation_template} [get_files $projpath/$proj_name/$proj_name.srcs/sources_1/ip/clk_wiz_0_1/syspll.xci]
