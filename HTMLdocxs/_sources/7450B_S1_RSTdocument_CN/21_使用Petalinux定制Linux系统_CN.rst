...
.. image:: images/21_media/image27.png
...
.. image:: images/21_media/image28.png

.. image:: images/21_media/image29.png
   
3) 将SD卡插入板卡内，跳线帽选择SD卡启动模式，板卡连接好串口。

.. image:: images/21_media/image30.jpeg
   
4) 解压资料中的CP210x_Windows_Drivers压缩包，根据当前系统安装相应的驱动，然后打开putty软件，根据设备管理器中的端口号，在软件中填入相关信息，设置好波特率。

.. image:: images/21_media/image31.png
   
.. image:: images/21_media/image32.png
   
5) 板卡插上电源，上电启动开发板

.. image:: images/21_media/image33.png

6) 使用petalinux登录，密码由用户设置，然后需要再次输入密码，成功后就可以进入系统控制台进行操作，插上网线后（路由器支持自动获取IP），使用ifconfig命令可以看到网络状态。

.. image:: images/21_media/image34.png
...
.. image:: images/21_media/image35.png
...
.. image:: images/21_media/image36.png

注：如果制作bsp包的工程可以编译成功，那使用bsp包制作的工程也可以直接编译。

.. image:: images/21_media/image37.png
...
.. image:: images/21_media/image38.png
...
.. image:: images/21_media/image39.png

.. |IMG_256| image:: images/21_media/image18.png
.. |image1| image:: images/21_media/image19.png
